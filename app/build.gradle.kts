...
android {
    namespace = "io.github.ssayala.ledticker"
    compileSdk = 36
...
// No JVM toolchain: compile with whichever JDK runs Gradle (17+), emitting
// 17-compatible bytecode. Avoids needing a separately-provisioned JDK 17.
kotlin {
    compilerOptions {
